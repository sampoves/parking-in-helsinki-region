...
function insertMySQL($timestamp, $ip, $zipcode, $likert, $parkspot, $parktime) {
	$sql = "INSERT INTO records (timestamp, ip, zipcode, likert, parkspot, parktime) VALUES ('" .$timestamp. "','" .$ip. "','" .$zipcode. "'," .$likert. "," .$parkspot. "," .$parktime. ")";
	return $sql;
}
