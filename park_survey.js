...
var popupContent = 
    ...
    '<div class="form-group">'+
        ...
        '<input type="number" min="0" max="120" placeholder="Required" class="form-control" id="parktime" name="parktime" onkeyup="if(this.value > 120) this.value = 120; else if(this.value < 0) this.value = 0; else this.value = parseInt(this.value, 10);">'+
    '</div>'+
